...
def modify_command_options(opts):
    if opts.dataset == 'voc':
        opts.num_classes = 21
        opts.output_stride = [4, 2, 2, 1] #new
    elif opts.dataset == 'LUAD-HistoSeg':
        opts.num_classes = 4
        opts.output_stride = [4, 2, 2, 1] #new
    elif opts.dataset == 'BCSS-WSSS':
        opts.num_classes = 4
        opts.output_stride = [4, 2, 2, 1] #new
    elif opts.dataset == 'WSSS4LUAD':
        opts.num_classes = 3
        opts.output_stride = [4, 2, 2, 1] #new
    ...
    # opts.pooling = opts.crop_size // opts.output_stride[0] #modify
...
def get_argparser():
    ...
    parser.add_argument("--stage", type=str, default="one", choices=['one', 'two'],
                        help="Training in one-stage or two-stage")
    parser.add_argument("--phase", type=int, default=0,
                        help="The phase in stage.(default: 0)")
    ...
    parser.add_argument("--dataset", type=str, default='LUAD-HistoSeg', help='Name of dataset')
    ...
    parser.add_argument("--lr_policy", type=str, default='poly',
                        choices=['polyLR', 'poly', 'step', 'none', 'warmup', 'one_cycle'],
    ...
    # Model Options
    parser.add_argument("--backbone", type=str, default='mit_b4',
                        choices=['SwinUNETR', 'swin_t', 'resnet50', 'resnet101', 'wider_resnet38_a2', 'mit_b1', 'mit_b0', 'mit_b2', 'mit_b3', 'mit_b4', 'mit_b5'],
    ...
    parser.add_argument("--pool", type=str, default="gmp",
                        help='Which pooling method to use in pseudolabeler.')
    ...
    parser.add_argument("--task", type=str, default="offline", choices=tasks.get_task_list(),
