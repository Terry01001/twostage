...
class MixVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=4, embed_dims=[64, 128, 256, 512],
                 num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=False, qk_scale=None, drop_rate=0.,
                 attn_drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm,
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], stride=[4, 2, 2, 1]):
        super().__init__()
        ...
        self.patch_size = patch_size
        #print(stride)
        #print(embed_dims) #mit_b1:[64, 128, 320, 512]
    ...
    def forward_features(self, x):
        ...
        # print(x.shape) #torch.Size([24, 16384, 64])
        # print(H) #128
        # print(W) #128
